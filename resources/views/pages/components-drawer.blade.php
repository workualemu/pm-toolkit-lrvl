<x-app-layout title="Drawer Component" is-sidebar-open="true" is-header-blur="true" sidebarToggle="true">
        ...
        <div class="grid grid-cols-1 gap-4 sm:gap-5 lg:gap-6">
          ...
          <div class="card px-4 pb-4 sm:px-5">
            ...
            <div>
              ...
              <div class="mt-5">
                <button
                  @click="$dispatch('show-drawer', { drawerId: 'left-drawer' })"
          ...
          <div class="card px-4 pb-4 sm:px-5">
            ...
            <div>
              ...
              <div class="mt-5">
                <button
                  @click="$dispatch('show-drawer', { drawerId: 'right-drawer' })"
                  class="btn bg-slate-150 font-medium text-slate-800 hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200/80 dark:bg-navy-500 dark:text-navy-50 dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90"
                >
                  Right Drawer
                </button>
            ...
            <div class="flex space-x-5 px-5">
              ...
              <div class="mt-2 w-full">
                <div class="flex justify-between space-x-3">
                  <h4
                    class="text-base font-medium text-slate-700 line-clamp-1 dark:text-navy-50"
                  >
                    John Doe
                  </h4>
                  <div
                ...
                <a
                  href="#"
                  class="cursor-pointer text-xs+ text-primary hover:text-primary-focus dark:text-accent-light dark:hover:text-accent"
                  >@johndoe</a
                >
              </div>
            </div>
