        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 lg:grid-cols-3 lg:gap-6 xl:grid-cols-4">
            <div class="card">
                <div class="h-24 rounded-t-lg bg-primary dark:bg-accent">
                    <img class="h-full w-full rounded-t-lg object-cover object-center " src="{{asset('images/800x600.png')}}"
                        alt="image" />
                </div>
                <div class="px-4 py-2 sm:px-5">
                    ...
                    <div class="flex items-center space-x-4 pt-2">
                        <div class="w-9/12">
                            <div class="ax-transparent-gridline" x-init="$nextTick(() => { $el._x_chart = new ApexCharts($el, pages.charts.cardUser1);
            ...
            <div class="card">
                ...
                <div class="px-4 py-2 sm:px-5">
                    ...
                    <div class="flex items-center space-x-4 pt-2">
                        <div class="w-9/12">
                            <div class="ax-transparent-gridline" x-init="$nextTick(() => { $el._x_chart = new ApexCharts($el, pages.charts.cardUser2);
                                $el._x_chart.render() });"></div>
                        </div>
                        <div class="w-3/12 text-center">
                            <p class="text-xl font-medium text-slate-700 dark:text-navy-100">
            ...
            <div class="card">
                ...
                <div class="px-4 py-2 sm:px-5">
                    ...
                    <div class="flex items-center space-x-4 pt-2">
                        <div class="w-9/12">
                            <div class="ax-transparent-gridline" x-init="$nextTick(() => { $el._x_chart = new ApexCharts($el, pages.charts.cardUser3);
                                $el._x_chart.render() });"></div>
                        </div>
                        <div class="w-3/12 text-center">
                            <p class="text-xl font-medium text-slate-700 dark:text-navy-100">
            ...
            <div class="card">
                ...
                <div class="px-4 py-2 sm:px-5">
                    ...
                    <div class="flex items-center space-x-4 pt-2">
                        <div class="w-9/12">
                            <div class="ax-transparent-gridline" x-init="$nextTick(() => { $el._x_chart = new ApexCharts($el, pages.charts.cardUser4);
                                $el._x_chart.render() });"></div>
                        </div>
                        <div class="w-3/12 text-center">
                            <p class="text-xl font-medium text-slate-700 dark:text-navy-100">
            ...
            <div class="card">
                ...
                <div class="px-4 py-2 sm:px-5">
                    ...
                    <div class="flex items-center space-x-4 pt-2">
                        <div class="w-9/12">
                            <div class="ax-transparent-gridline" x-init="$nextTick(() => { $el._x_chart = new ApexCharts($el, pages.charts.cardUser5);
                                $el._x_chart.render() });"></div>
                        </div>
                        <div class="w-3/12 text-center">
                            <p class="text-xl font-medium text-slate-700 dark:text-navy-100">
