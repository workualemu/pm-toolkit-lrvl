<x-app-layout title="Tasks" is-sidebar-open="true" is-header-blur="true" has-min-sidebar="false" sidebarToggle="true">
    <!-- Sidebar -->
  ...
  @livewire('tasks', ['tasks' => $tasks, 'project' => $project], key('task-frame001'))
