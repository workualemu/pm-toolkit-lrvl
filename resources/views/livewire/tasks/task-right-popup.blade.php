                    ...
                    <div class="w-full h-full outline-none overflow-x-hidden overflow-y-auto grid grid-cols-12 gap-4 sm:gap-5 lg:gap-6">
                        <div class="col-span-12 sm:col-span-6 lg:col-span-8">
                            <div class="is-scrollbar-hidden flex grow flex-col space-y-4 overflow-y-auto p-4">
                                ...
                                <div class="flex grid col-2 w-full ">  
                                    <x-select 
                                        ...
                                        defaultText="{{ __('Select assignee') }}"
                                    />
                                    <x-select 
                                        ...
                                        nameField="name"
                                        selected="{{ $report_by }}"
                                        defaultText="{{ __('Select reporter') }}"
                                    />
                                </div>
                                <div>
                            ...
                            <div class="col-span-12 sm:col-span-6 lg:col-span-8">
                                <div class="is-scrollbar-hidden flex grow flex-col space-y-4 p-4">
                                    <x-select 
                                        ...
                                        valueField="id"
                                        nameField="label"
                                        defaultText="{{ __('Select tags') }}"
                                        multiple
                                    />
                                    <x-select 
                                        label="{{ __('Priority') }}"
                                        model="task_priority_id"
                                        :options="$taskPriorities"
                                        valueField="id"
                                        nameField="value"
                                        defaultText="{{ __('Select priority') }}"
                                    />
                                    <x-select 
                                        label="{{ __('Status') }}"
                                        model="task_status_id"
                                        :options="$taskStatuses"
                                        valueField="id"
                                        nameField="value"
                                        defaultText="{{ __('Select status') }}"
                                    />
                                </div>
                            </div>
                        </div>
