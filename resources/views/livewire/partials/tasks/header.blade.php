<div class="" x-data="{ isFilterExpanded: false }"
    ...
    <div class="relative hidden w-full max-w-[12rem] sm:flex">
        <button x-tooltip="'Filter'"
            ...
            class="ml-auto btn h-9 w-9 p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
